            ...
            <div class="search-wrapper">
                ...
                <div class="stat-card" style="margin-bottom: 30px;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <asp:TextBox ID="txtSearch" runat="server" placeholder="What are you craving? (e.g. Pizza, Biryani)" CssClass="form-input" style="flex:1;"></asp:TextBox>
                        <asp:Button ID="btnSearch" runat="server" Text="Search Menu" CssClass="btn-primary" OnClick="btnSearch_Click" />
                    </div>
                </div>
                    ...
                    <asp:GridView ID="gvResults" runat="server" AutoGenerateColumns="False" CssClass="results-table" GridLines="None" DataKeyNames="ItemID,RestaurantID" OnRowCommand="gvResults_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:Button ID="btnOrder" runat="server" Text="Order Now" CommandName="Order" CommandArgument='<%# Container.DataItemIndex %>' CssClass="btn-view" style="padding: 5px 15px; font-size: 0.8rem;" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <EmptyDataTemplate>
